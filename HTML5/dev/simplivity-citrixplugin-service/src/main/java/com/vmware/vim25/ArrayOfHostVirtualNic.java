...
public class ArrayOfHostVirtualNic {
    ...
    private final static com.vmware.vim25.HostVirtualNic[] NULL_HOST_VIRTUAL_NIC_ARRAY = new com.vmware.vim25.HostVirtualNic[ 0 ] ;
    public com.vmware.vim25.HostVirtualNic[] HostVirtualNic;

    public com.vmware.vim25.HostVirtualNic[] getHostVirtualNic() {
        if ((HostVirtualNic) == null) {
            return (NULL_HOST_VIRTUAL_NIC_ARRAY);
        }
