...
public class ArrayOfHostVirtualNicConfig {
    ...
    private final static com.vmware.vim25.HostVirtualNicConfig[] NULL_HOST_VIRTUAL_NIC_CONFIG_ARRAY = new com.vmware.vim25.HostVirtualNicConfig[ 0 ] ;
    public com.vmware.vim25.HostVirtualNicConfig[] HostVirtualNicConfig;

    public com.vmware.vim25.HostVirtualNicConfig[] getHostVirtualNicConfig() {
        if ((HostVirtualNicConfig) == null) {
            return (NULL_HOST_VIRTUAL_NIC_CONFIG_ARRAY);
        }
